...
config :addict, user: ExampleApp.User,
                ...
                db: ExampleApp.Repo,
                register_from_email: "ExampleApp <postmaster@sandbox0b5bee2086bd446c90137e0458ae94cd.mailgun.org>",
                register_subject: "Welcome to ExampleApp!",
                password_recover_from_email: "ExampleApp <postmaster@sandbox0b5bee2086bd446c90137e0458ae94cd.mailgun.org>",
